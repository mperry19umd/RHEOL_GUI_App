function ProfileFigureExport(ifig,fname,axst0,axth0,axgs0)
% ifig=1;
...
axdef=axes;
axstpos=get(axdef,'Position');
delete(axdef)

axth=copyobj(axth0,ifig);
axgs=copyobj(axgs0,ifig);
...
axthpos=axstpos;
axthpos(3)=axstpos(5)/2; %inner 
axstpos(1)=axthpos(1)+axthpos(3); %outer
axstpos(3)=axthpos(3);
axgspos(3)=axstpos(3)/2;
